...
the \moc{SYBILT:} (with EURYDICE-2 option) or \moc{MCCGT:} module. By default, the \moc{PIJ}
option is used.

\item[\moc{PIJ}] keyword to specify that the standard scattering-reduced collision
probabilities must be computed. This option cannot be used with the \moc{MCCGT:}
