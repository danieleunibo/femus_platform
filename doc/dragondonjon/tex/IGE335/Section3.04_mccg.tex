...
\item[\moc{MAXI}] keyword to specify the maximum number of inner iterations (or Bi-CGSTAB iterations to solve the ACA-simplified system if  \moc{DIFC} is present).
