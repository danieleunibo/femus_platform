...
\item[\moc{POWER}] keyword used to normalize the flux. If this keyword is not used, the flux directly computed by the \moc{FLUD:} is used to perform the pin-power reconstruction,  then normalization has to be performed by the user indepently. 
